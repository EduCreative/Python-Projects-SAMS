...
class Face_Recognition_System:
    def __init__(self, root):
        ...
        b2=Button(bg_img, image=self.btn2, command=self.face_data, cursor="hand2", bg="blue")
        b2.place(x=20,y=400, width=140, height=100)

        b2_2=Button(bg_img, text="Face Recognition", command=self.face_data, cursor="hand2", font=("Arial",10, "bold"))
        b2_2.place(x=20,y=500, width=140, height=40)
        ...
        b3.place(x=20,y=700, width=140, height=100)

        b3_3=Button(bg_img, text="Add Attendance", cursor="hand2", font=("Arial",10, "bold"))
        b3_3.place(x=20,y=800, width=140, height=40)
        ...
        b8.place(x=420,y=700, width=140, height=100)

        b8_8=Button(bg_img, text=" Exit ", cursor="hand2", font=("Arial",10, "bold"))
        b8_8.place(x=420,y=800, width=140, height=40)
